...
| MCP tools | N/A | Full | Full | Generated as native tools; stdio, HTTP, and SSE work without interactive auth. Inspection follows at most 50 `tools/list` pages and rejects a repeated cursor |
